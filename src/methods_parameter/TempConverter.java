...
public static void main(String args[]){
								...
								//float f = 34536.89;    //  This line of code will throw error since Java default considers any decimal value as double and hence we try to save float we need to specify explicitly
